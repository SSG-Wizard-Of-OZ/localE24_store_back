...
public class EventController {
    ...
    @PutMapping("/assigned/update")
    public ResponseEntity<Integer> putOne(@RequestBody EventUpdateDTO statusDTO){

        log.info("---------------------------" + statusDTO);

        return ResponseEntity.ok().body(eventService.putStatus(statusDTO));
    };
}
